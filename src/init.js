  ...
  const pingers = [{
    ...
    query: `
      ...
      WHERE created_at > ?
        ...
        AND price <= 50000
        AND (
          (area >= 3000 AND area <= 5000 AND (area_measurement = "m2" OR area_measurement IS NULL)) OR
          (area >= 0.2 AND area <= 0.5 AND area_measurement = "ha")
        )
        AND ST_Contains(ST_GeomFromText('POLYGON((56.95396 23.92479, 56.9225 23.9138, 56.87487 23.92067, 56.83132 24.03946, 56.86511 24.14314, 56.87985 24.1937, 56.90544 24.24303, 56.94714 24.27834, 56.96108 24.39171, 56.99344 24.33231, 57.01642 24.29417, 57.06164 24.16855, 57.02354 24.01646, 56.95396 23.92479))'), point(lat, lng))
      ORDER BY created_at
    `,
  }, {
    id: 12, // Zeme ar maju
