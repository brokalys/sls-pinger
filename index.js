...
.then((date) => {
  ...
  const query = `
    ...
    WHERE created_at > ? 
      ...
      AND price >= 180
      AND (
        ST_Contains(ST_GeomFromText('POLYGON((56.94806 24.0798, 56.93907 24.09336, 56.95518 24.15087, 56.96819 24.12752, 56.94806 24.0798))'), point(lat, lng))
        OR ST_Contains(ST_GeomFromText('POLYGON((56.96538 24.20769, 56.94619 24.20666, 56.95356 24.15364, 56.96718 24.14899, 56.96987 24.18468, 56.96538 24.20769))'), point(lat, lng))
      )
    ORDER BY created_at
  `;
